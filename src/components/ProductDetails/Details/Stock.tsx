...
const Stock=({stock}:IProps)=> {
  return (
    <Fragment>
        ...
        <div className='flex items-center space-x-8 my-4 '>
            <span className='text-md font-bold border-1 border border-green-400  text-green-500 p-1 rounded-md'>{stock.price} EGP</span>
  ...
  <button className="w-8 h-8 flex items-center justify-center p-1 rounded-full  text-black bg-white border border-gray-500">+</button>
        ...
        <div className='bg-black w-2/3  rounded-md text-lg  text-slate-100  py-2 flex justify-center gap-2 '>
        <ShoppingBag />
            Add To bag
        </div>
        </div>

...
import { Plus, ShoppingBag, Sparkles,Minus  } from 'lucide-react'
interface IProps{
stock:IStock[]
}
const Stock=({stock}:IProps)=> {
  ...
  <button className="size-6  flex items-center justify-center p-1 rounded-full  text-black bg-white border border-gray-500"><Minus /></button>
  <h6>{stock.in_stock}</h6>
  <button className="size-6  flex items-center justify-center p-1 rounded-full  text-black bg-white border border-gray-500"><Plus/></button>
</div>
